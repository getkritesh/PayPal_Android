package com.kritesh.paypal.paymentservice.ui;
...
import com.kritesh.paypal.paymentservice.PayPalAPI;
import com.kritesh.paypal.paymentservice.R;
import com.kritesh.paypal.paymentservice.adapters.ProductListAdapter;
import com.kritesh.paypal.paymentservice.library.ActionItemBadge;
...
public class ProductsActivity extends AppCompatActivity implements ProductListAdapter.AddToCartCallback{
    ...
    private void contactUs(){
        Intent emailIntent = new Intent(Intent.ACTION_SENDTO, Uri.fromParts(
                "mailto","tripathi.kritesh@gmail.com", null));
